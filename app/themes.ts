...
export const storyScenes: Record<string, Scene[]> = {
 ...
 greenhouse: palette('greenhouse', 'svg', [['#0b1a2e','#14273f','#1f3a55','#5f7f9c','#7fe3d1'],['#0d2233','#173245','#224559','#5f8496','#9fe8c4'],['#101a30','#1a2843','#273a58','#63769a','#8ed7ff'],['#0e1f2a','#183040','#244455','#5d8090','#b8f0a8']]),
 theatre: palette('theatre', 'svg', [['#2a0f16','#3d1a24','#552735','#8f5f6c','#f2c66b'],['#1d1224','#2c1b36','#3f2a4c','#7a6386','#f0c47a'],['#31121a','#452029','#5c2f3c','#966a78','#ffd27f'],['#241014','#37191f','#4b262d','#87626a','#f4cf85']]),
 aquarium: palette('aquarium', 'svg', [['#061c2e','#0d2b42','#153d58','#4f7f9a','#ff9f7a'],['#07222f','#0f3344','#17475a','#4f8496','#7fe6e0'],['#0a1a33','#132a4a','#1c3d62','#5677a0','#ffc07a'],['#052430','#0c3644','#164a5a','#4d8a99','#8ef0d6']]),
 bakery: palette('bakery', 'svg', [['#2a1a10','#3d281a','#523825','#957a5e','#f4c56a'],['#241b14','#372a20','#4b3a2c','#8d7a68','#ffd58a'],['#2b1c12','#402b1d','#563c2a','#9a7f66','#f7cf7a'],['#1f1610','#32241a','#463326','#87715c','#ffe08f']]),
 lighthouse: palette('lighthouse', 'svg', [['#071528','#0f2340','#183356','#4f6c94','#ffe27a'],['#0a1a30','#132a48','#1d3c60','#557398','#9fd8ff'],['#0b1730','#152646','#20385f','#5a7299','#ffd76a'],['#081a2c','#112b44','#1a3d5b','#4f7392','#fff0a0']]),
