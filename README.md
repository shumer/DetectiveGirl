...
Доступны четыре переведённых дела: пропавшая сова, лесные фонари, посылка на облачный остров и тени в музее. Пятое дело, «Тайна золотой совы», это пилот нового уровня сложности, пока только на русском, см. `docs/pilot.ru.md`. В каждом четыре связанных шага, три подсказки на шаг, блокнот выводов и развязка. Все четыре дела переведены на русский, польский, английский и украинский.
...
- `app/pilot/owl.json` - пилотное дело с новыми механиками (отметить нескольких, обратная связь по вариантам, счётчик ошибок).
...
- `tests/revision.test.ts`, `tests/reviewed-content.test.ts`, `tests/pilot.test.ts` - проверка ответов, структуры переводов, пилота и доступности иллюстраций.
